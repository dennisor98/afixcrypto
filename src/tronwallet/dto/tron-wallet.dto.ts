...
export class Convert {
    public static toWallet(json: string): WalletDto {
        return cast(JSON.parse(json), r("Wallet"));
    }

    public static walletToJson(value: WalletDto): string {
