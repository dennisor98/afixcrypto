...
export class Convert {
    public static toDeposit(json: string): Deposit[] {
        return cast(JSON.parse(json), a(r("Deposit")));
    }

    public static depositToJson(value: Deposit[]): string {
        return JSON.stringify(uncast(value, a(r("Deposit"))), null, 2);
    }
}
...
const typeMap: any = {
    "Deposit": o([
        ...
        { json: "token_info", js: "token_info", typ: u(undefined, r("TokenInfo")) },
        { json: "block_timestamp", js: "block_timestamp", typ: u(undefined, 0) },
